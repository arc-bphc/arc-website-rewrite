...
import tentacles from "./giphy_0-5.gif";
import starfish from "./starfish.gif";
import fabric from "./pnas-robotic-fabric2.webp";
...
<Image
  src={tentacles}
  alt="tentacles"
  width={tentacles.width}
  height={tentacles.height}
  style={{
    borderRadius: "8px",
    margin: "1rem auto",
    display: "block"
...
<Image
  src={starfish}
  alt="starfish"
  width={starfish.width/0.5}
  height={starfish.height/0.5}
  style={{
    borderRadius: "8px",
    margin: "1rem auto",
    display: "block"
...
<div style={{ display: "flex", justifyContent: "center", margin: "1.5rem 0" }}>
  <iframe
    width="912"
    height="513"
    src="https://www.youtube.com/embed/XMVjn7bpF-Q"
    title="Soft robot in surgical simulation"
    frameborder="0"
...
<Image
  src={fabric}
  alt="fabric"
  width={fabric.width / 2}
  height={fabric.height / 1.5}
  style={{
    borderRadius: "8px",
    margin: "1rem auto",
    display: "block"
